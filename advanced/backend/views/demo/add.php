...
<div class="left">
    <ul>
        <li><a href="<?= Url::to(['demo/show']) ?>">查看注册字段</a></li>
        <li class="selected"><a href="<?= Url::to(['demo/add']) ?>">添加注册字段</a></li>
    </ul>
</div>

<div class="right">
    <div class="search-box">
        <form action="index.php?r=demo/index" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                ...
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" name="filed_num" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" name="filed_xuan" value="0"  class="filed-name" placeholder="选项1">
                    <input type="text" name="filed_xuan" value="0"  class="filed-name" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="radio" name="filed_bi" value="1">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" name="filed_length[]" type="text" placeholder="请输入最小长度">
                    ~
                    <input class="length" name="filed_length[]" type="text" placeholder="请输入最大长度">
                </li>
                <li>
