...
<div class="left">
    <ul>
        <li class="selected"><a href="<?= Url::to(['demo/show']) ?>">查看注册字段</a></li>
        <li><a href="<?= Url::to(['demo/add']) ?>">添加注册字段</a></li>
    </ul>
</div>
    ...
    <div class="search-box">
        <table>
            ...
            <tr>
                ...
                <td><?=$v['filed_bi']?></td>
                <td><?=$v['filed_gui']?></td>
                <td><?=$v['filed_length']?></td>
                <td>
                    <a href="<?= Url::toRoute(['demo/find','id'=>$v['id']])?>">编辑</a>
                    |
