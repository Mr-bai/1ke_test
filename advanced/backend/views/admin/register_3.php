    ...
    <div class="check_label">
        ...
        <p class="intrest_label">
            <?php foreach ($arr as $k => $v): ?>
                <input type="button" name="hobby" class="a_selected" value="<?php echo $v['hobby_name'] ?>" >
            <?php endforeach ?>
        </p>
        <p class="handler-button">
            <a class="a_button" href="<?php echo Url::toRoute(['admin/register_2']);?>">上一步</a>
            <a class="a_button" href="<?php echo Url::toRoute(['admin/save','hobby'=>$v['hobby_name']]);?>">完成</a>
        </p>
    </div>
</div>
